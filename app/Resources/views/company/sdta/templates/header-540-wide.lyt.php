		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tbody>
					...
					<tr>
						<td style="padding-top: 20px;" class="imagecont"><a class="dest_url" href="#"><img data-width="540" data-height="215"  class="fullwidth editableImage drop-area fa-external-link" src="http://image.updates.sandiego.org/lib/fe9e15707566017871/m/4/placeholderimage_540x215.gif" alt="Happiness is Calling from San Diego" border="0" width="540" style="display: block; height: auto !important;" /></a></td>
					</tr>
					<tr>
                  ...
                  <span class="editable headline maintitle unedited">MAIN TITLE OR HEADLINE</span>  
									...
									<td align="right" valign="top"><a class="dest_url" href="#"><img class="link" src="http://image.updates.sandiego.org/lib/fe9e15707566017871/m/4/sdta_nl_arrow_orange-filled.png" align="baseline" style="vertical-align: baseline; padding-left: 7px;" border="0" /></a><img src="http://image.updates.sandiego.org/lib/fe9e15707566017871/m/2/spacer-10.gif" border="0" /></td>
								</tr>
							</tbody>
						</table>
						</td>
...
{{ include('company/sdta/_controls.html', {controls:'header-540',colors:true}) }}
{% endblock %}
